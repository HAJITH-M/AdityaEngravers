        ...
        <div className="mt-6">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="pt-6">
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8 h-full flex flex-col">
                <div className="flex-grow">
                  <div>
                    <span className="inline-flex items-center justify-center p-3 mt-4 bg-indigo-500 rounded-md shadow-lg">
                      <FaHandshake className="h-6 w-6 text-white" />
                    </span>
                  </div>
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Local Support</h3>
            ...
            <div className="pt-6">
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8 h-full flex flex-col">
                <div className="flex-grow">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Satisfied Customers</h3>
                  <p className="mt-5 text-base text-gray-500">
            ...
            <div className="pt-6">
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8 h-full flex flex-col">
                <div className="flex-grow">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Quality Products</h3>
                  <p className="mt-5 text-base text-gray-500">
